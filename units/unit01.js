class Unit01 {
    ...
    loadAnimations() {
        // walking
        this.animations.push(new Animator(this.spritesheet, 46, 1189, 354, 347, 18, 0.075, 0, false, true, this.isEnemy));
        // attacking
        this.animations.push(new Animator(this.spritesheet, 50, 638, 612, 442, 22, 0.075, 0, false, true, this.isEnemy));
        // dying
        this.animations.push(new Animator(this.spritesheet, 46, 69, 507, 426, 42, 0.05, 0, false, true, this.isEnemy));
    }
