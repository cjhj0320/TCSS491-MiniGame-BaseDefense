class Unit03 {
    ...
    constructor(game, isEnemy) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./img/unit/unit03.png");
    ...
    loadAnimations() {
        // walking
        this.animations.push(new Animator(this.spritesheet, 50, 1245, 422, 339, 18, 0.075, 0, false, true, this.isEnemy));
        // attacking
        this.animations.push(new Animator(this.spritesheet, 51, 675, 609, 470, 22, 0.075, 0, false, true, this.isEnemy));
        // dying
        this.animations.push(new Animator(this.spritesheet, 51, 22, 556, 510, 43, 0.05, 0, false, true, this.isEnemy));
    }

    updateBB() {
        this.BB = new BoundingBox(this.x, this.y, 422 * PARAMS.SCALE, 339 * PARAMS.SCALE);
    };
